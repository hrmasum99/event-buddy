import { Body, Controller, Delete, Get, NotFoundException, Param, ParseIntPipe, Patch, Post, Put, Req, Res, UploadedFile, UseGuards, UseInterceptors } from "@nestjs/common";
import { JwtAuthGuard } from "src/common/guards/jwt-auth.guard";
import { EventsService } from "src/events/events.service";
import { CreateEventDTO } from "src/events/dto/create-event.dto";
import { EventResponseDTO } from "src/events/dto/event-response.dto";
import { UpdateEventDTO, UploadImageDTO } from "src/events/dto/update-event.dto";
...
export class UserController {
  ...
  async createEvent(@Body() eventData: CreateEventDTO): Promise<EventResponseDTO> {
  ...
  async uploadEventImage(@Param('id') id:number, 
  ...
  async updateProfile(@Param('id') id:number, @Body() updateEventDto: UpdateEventDTO): Promise<EventResponseDTO>{
  ...
  async updateEventImage(@Param('id') id:number, 
    @Body() updateEventDto:UploadImageDTO,
    @UploadedFile() file: Express.Multer.File,
  ): Promise<any> {
    updateEventDto.file = file.filename;
